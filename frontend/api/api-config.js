...
// Backend API base URL (for calling our Node.js server)
// Note: BACKEND_URL includes /api, but we need just the base URL for genre-browser.js
const backendUrl = window.AppConfig?.get('BACKEND_URL') || 'http://localhost:5000/api';
const API_BASE = backendUrl.replace('/api', ''); // Remove /api suffix to get base URL
